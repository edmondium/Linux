...
#define PRIVATE_LB_TEST( v, e )  BOOST_TEST( ::static_log2<v>::value == e )
#define PRIVATE_PRINT_LB( v )    ::cout << "boost::static_log2<" << (v) \
 << "> = " << ::static_log2< (v) >::value << '.' << ::std::endl
...
{    
    ...
    cout << "Doing tests on static_log2." << endl;
    PRIVATE_LB_0_TEST;
